...
/**
 * Activity for testing Bg1 device. 
 */
public class BG1 extends Activity {

	private static final String TAG = "BG1Demo";
	...
	BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			//1304
				...
				mTextView.append(SDF.format(new Date()) + "1304 idenFlag：" + iden1304 + "\n");
				if(iden1304 == 1) {
					new Thread() {
						public void run() {
				...
				if(flag1304 == 0) {
					mTextView.append(SDF.format(new Date()) + "connect successfully,ready to measure\n");
				} else {
			...
			//1305
				...
				mTextView.append(SDF.format(new Date()) + "BG1 deviceInfo = " + idps + "\n");
				if(!idps.equals("")) {
					new Thread() {
						public void run() {
